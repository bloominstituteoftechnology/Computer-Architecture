...
ls8 examples - contains bytes seperated by row. Looks like opcodes to accomplish certain tasks.
cpu.py - contains the class to 'run' the computer
ls8.py - is like a test file for our cpu class
ls8-cheatsheet - has opcodes and their binary equivalent
ls8-spec - Looks like everything we will need to implement in this computer
