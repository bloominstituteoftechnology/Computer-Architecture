...
- Make a list of files here.
  -asm.py : opcode list~type and code; data handling functions
  -asm folder: several tests as .asm files
  -ls8 examples folder: binary strings for functions in ls8
  -cpu.py: CPU class defined, several areas that need code
  -ls8.py: calls the cpu 'load' and 'run' functions
