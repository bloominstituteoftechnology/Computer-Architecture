...
- ls8.py >> runs the emulator for lambdaSchool-8

- Write a short 3-10-word description of what each file does.
- Note what has been implemented, and what hasn't.
- Read this whole file.
- Skim the spec.
- cpu.py >> Methods: load() - loads a program into memory, alu(op, reg_a, reg_b) -
- runs ALU operations, trace(), prints out CPU state, run() - runs the CPU
-
- ls8.py >> new CPU created, loaded, and run
